...
@Component({
  ...
  templateUrl: './formulario-tarea-crear-admin.component.html',
  styleUrls: ['./formulario-tarea-crear-admin.component.css'],
})
export class FormularioTareaCrearAdminComponent {
