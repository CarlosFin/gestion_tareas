...
@Component({
  ...
  templateUrl: './formulario-generico-tarea-crear.component.html',
  styleUrls: ['./formulario-generico-tarea-crear.component.css'],
})
export class FormularioGenericoTareaCrearComponent {
